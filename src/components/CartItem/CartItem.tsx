...
const CartItemSimple: FC<CartItemProps> = ({ id, uid, imageUrl, title, type, size, price, count }) => {

    const isMinusDisabled = count <= 1 ? true : false;
	console.log('isMinusDisabled: ', id, isMinusDisabled);
	const dispatch = useAppDispatch();
    const onClickMinus = () => {
        dispatch(decrItemCount(uid));
    };
    const onClickPlus = () => {
        dispatch(incrItemCount(uid));
    };
    const onClickRemove = () => {
...
export const CartItem = memo(CartItemSimple);